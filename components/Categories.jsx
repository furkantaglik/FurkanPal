                    ...
                    navLinks={[
                        {
                            ...
                            style: "bg-black py-2 md:py-5 md:px-12 text-center md:text-xl text-sm font-medium rounded-lg border border-gray-700 hover:text-white hover:border-red-600"
                        },
                    ]}
                />
            ))}
