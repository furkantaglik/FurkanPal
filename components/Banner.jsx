    ...
    return (
        <div className='flex flex-col py-5 md:py-10 gap-6 md:gap-12 max-w-screen-xl mx-auto px-2'>
            ...
            <div className='flex gap-2'>
                <Link href={`/Watch/${id}`} className='flex items-center justify-center bg-white text-black hover:bg-black hover:text-red-500 transition duration-300 px-20 md:px-28 py-5 rounded-full text-xl font-extrabold whitespace-nowrap overflow-hidden'>
                    Watch !
                </Link>
                <button aria-label='ekle' className='flex items-center justify-center px-4 rounded-full text-2xl border-2 border-white hover:border-red-600 hover:text-red-600 hover:bg-black'>
                    <FaPlus />
                </button>
