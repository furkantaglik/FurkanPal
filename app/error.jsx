    ...
    return (
        <section class="grid place-items-center p-5 my-28 w-fit mx-auto rounded-lg border border-zinc-700">
            <div className='text-center'>
                <p className='text-base font-semibold text-sky-600'>Bir Problem Var !</p>
                ...
                <p className='mt-6 text-base leading-7 text-zinc-400'>Daha sonra Tekrar Dene</p>
            </div>
            <div className='mt-10 flex items-center justify-center gap-x-6'>
                ...
                <Link href="/" className='rounded-lg border p-2 border-slate-800 text-slate-300 hover:text-white'>
                    AnaSayfa
                </Link>
            </div>
        </section>
